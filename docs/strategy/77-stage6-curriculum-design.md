...
**대상**: `docs/strategy/73-geo-action-plan.md`의 90일 로드맵을 학습/실행형 모듈로 변환
...
기존 v1.0의 **기능별 7모듈** 구조에서 `docs/strategy/73-geo-action-plan.md`의 **Phase 순차 8모듈** 구조로 전환함.
...
### 문서
- ✅ `docs/strategy/77-stage6-curriculum-design.md` (이 문서)
...
### 참고 (유지보수)
- `docs/archive/deprecated/71-stage6-task-module-strategy.md` (변경 없음, 참고만)
- `docs/archive/deprecated/75-stage6-seed-content-preparation.md` (변경 없음, 참고만)
- `docs/tracking/90-log.md` (업데이트: Stage 6 설계 완료 기록)
